### Heatmap with the 28 OG genes + the 27 genes FROM EnRichR time point 1
## Antonio H.
# 10/21/2024
...
t1_dataset<- nod_sample_1 %>% full_join(ns_sample_1)

rm(gene_expected,nod_sample_1,ns_sample_1)
